...
class Sketch_RNN_Complete(nn.Module):
    """
    ...
    def __init__(self, no_cuda=True):
        ...
        super(Sketch_RNN_Complete, self).__init__()
        ...
        #TODO: change that
        self.expected_input_size = (self.n_max, sketch_point_size)
            ...
            if True:
                ...
                for b in range(batch_size):
                    if i >= n_s[b]:
                        ...
                        dx, dy = sample_gaussian_2d(t_mean1[b][idx].item(), t_mean2[b][idx].item(), t_std_x[b][idx].item(), t_std_y[b][idx].item(), t_cor[b][idx].item())
